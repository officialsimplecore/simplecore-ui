...
export class DatePicker extends CustomControl<Date> implements AfterContentInit, ControlValueAccessor, OnChanges, OnInit {
  ...
  @Input() highlightedDate?: Date;
        // This is a fixed date to be left highlighted in a transparent background. May be null.
  @Input() min?: Date | null;
